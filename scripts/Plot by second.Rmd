...
save.and.print <- function (plot.func, file.name, width = 10, height=20){
  pdf(file.path("../data", file.name), width, height)
  p <- plot.func()
  print(p)
  dev.off()
  print(plot.func())
...
for(level in 1:6){
  ...
  save.and.print(plot.one, paste0("Week.l", level, ".pdf"), width = 15, height=50)
  #
  plot.one <- function(){
  ...
  save.and.print(plot.one, paste0("Month.l", level, ".pdf"), width = 15, height=50)
  #
  plot.one <- function(){
    p <- ggplot(Day.Count) + 
  ...
  save.and.print(plot.one, paste0("Day.l", level, ".pdf"), width = 15, height=50)
}
